...
openai.api_key = "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"
...
def predict_single():
 ...
 #   print(predict_single())
  #  predicted_label, recommendation = predict_single()
   # print(f"Predicted land type: {predicted_label}")
    #print(f"Insights and recommendations: {recommendation}")
#else:
